...
var Floor = {
  OnOff1: {
    //Button for switching on the primary circuit
    type: 'switch',
  ...
  OnOff2: {
    //Button for turning on the second circuit
    type: 'switch',
  ...
  IsOn1: {
    //Primary circuit in heating mode
    type: 'switch',
  ...
  IsOn2: {
    //Second circuit in heating mode
    type: 'switch',
  ...
  Temp1: {
    //Primary heating element temperature
    type: 'temperature',
  ...
  Temp2: {
    //Second heating element temperature
    type: 'temperature',
  ...
  Alarm1: {
    //Malfunction in the primary circuit
    type: 'switch',
  ...
  Alarm2: {
    //Malfunction in the second circuit
    type: 'switch',
  ...
  Tmax: {
    //Upper heating element temperature set point
    type: 'temperature',
  ...
  Tmin: {
    //Lower heating element temperature set point
    type: 'temperature',
  ...
  Pmax1: {
    //Maximum permissible power of the primary circuit
    type: 'power',
  ...
  Pmax2: {
    //Maximum permissible power of the second circuit
    type: 'power',
...
defineRule('Heating1', {
  ...
  then: function () {
    if (
      dev[TempSensor1] < dev['Heating/Tmin'] &&
      dev['Heating/OnOff1'] == true &&
      dev['Heating/Alarm1'] == false
    ) {
...
defineRule('Heating2', {
  ...
  then: function () {
    if (
      dev[TempSensor2] < dev['Heating/Tmin'] &&
      dev['Heating/OnOff2'] == true &&
      dev['Heating/Alarm2'] == false
    ) {
...
defineRule('Alarm', {
  ...
  then: function () {
    if (dev[FirstPowerMeter] > Pmax1) {
      //If the power consumption exceeds the limit, the heating element current is faulty
